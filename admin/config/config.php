...
$CONFIG['admin']['app_url'] = 'http://localhost/portal-biodiv/kalbar/';
$CONFIG['admin']['base_url'] = 'http://localhost/portal-biodiv/kalbar/admin/';
$CONFIG['admin']['root_path'] = $_SERVER['DOCUMENT_ROOT'].'/portal-biodiv/kalbar/admin';

$CONFIG['admin']['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/portal-biodiv/kalbar/public_assets/';
